Feature: Contacts Page
  ...
  Scenario Outline: login as a given user DDF
   ...
   Scenario: Contacts test with email
     ...
     When the user click the "mbrackstone9@gmail.com" from contacts
  ...
  Scenario: Contacts test with email
    Given the user logged in as a "store manager"
    And the user navigates to "Customers" "Contacts"
    When the user click the "odugmore5@skura.ne.jp" from contacts
    Then the information "odugmore5@skura.ne.jp" should be the same with database
